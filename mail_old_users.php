...
$query = "select first_name, email from $dbname.users WHERE user_email_verified = 1 and is_active = 0";
...
while($row=$result->fetch_assoc())
    {
            ...
            . "\twhere everyone is talking about how hard it is to get the correct ICD10 code!\n"
            . "\tDmeHelp has been reorganized and improved, \n"
